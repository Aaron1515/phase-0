...
What is the difference between a local variable and a method?
  Local variable can be used anywhere locally on the file and doesn't have an argument.  Method could also contain its own local variables as well. Methods could also contain parameter or parameters.
