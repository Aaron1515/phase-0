...
What is the difference between a local variable and a method?
  Local variable can be used anywhere locally on the file.  Method are defined variable by the programer.  Method could also contain local variables as well. Methods could also contain parameter or parameters.

How do you run a ruby program from the command line?
  First you can start the ruby command line by typing "irb" and type your codes there and test them out. That is mainly to test out simple codes.
  Second you can also run a ruby file by typing "ruby [filename].rb" and run the file in command line.

How do you run an RSpec file from the command line?
  In command line you type "rspec [filename.rb]"  That will check the rspec to make sure you are running the code correctly that matches with the rspec file.
